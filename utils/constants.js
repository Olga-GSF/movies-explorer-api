...
const ERROR_MESSAGE = {
  ...
  GET_MOVIES_ERROR: 'Переданы некорректные данные при создании фильма',
  DELETE_MOVIESID_ERROR: 'Фильм с указанным _id не найден',
  ...
  REFUSAL_TO_DELETE: 'Запрещено удалять фильм другого пользователя',
